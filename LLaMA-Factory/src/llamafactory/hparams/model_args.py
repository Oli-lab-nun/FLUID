...
class ModelArguments(
    ...
    head_weight: float = field(
        default=0.1,
        metadata={"help": "Weight of the head."},
    )
    
    train_lm_head: bool = field(
        default=False,
        metadata={"help": "Whether to train the lm_head."},
    )

    stage1_pretrained_path: str = field(
        default=None,
        metadata={"help": "Path to the pretrained model for stage 1."},
    )

    #MDModel

    IS_MDModel: bool = field(
        default=False,
        metadata={"help": "Whether to train the MDModel."},
    )

    sampler_state_dict: str = field(
        default=None,
        metadata={"help": "Path to the Smpler of pretrained model"},
    )
    corrector_state_dict: str = field(
        default=None,
        metadata={"help": "Path to the Corrector of pretrained model"},
    )

    lora_adapter_path: str = field(
        default=None,
        metadata={"help": "Path to the Adapter of pretrained model"},
    )

    k_masks: str = field(
        default=None,
        metadata={"help": "numbers of masks"},
    )
